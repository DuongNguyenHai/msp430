...
public :
   ...
   size_t writeBytes(char *b, size_t size = 0);
   size_t writeBytes(int *d, size_t size = 0);
   ...
   // Read writeNumber
   size_t readBytes(char *b, size_t size = BUFF_SIZE-1);
   size_t readBytes(int *d, size_t size = BUFF_SIZE-1);
