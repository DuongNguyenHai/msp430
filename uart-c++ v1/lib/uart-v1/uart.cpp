...
size_t Uart::write(unsigned char num) {
	return writeNum((float)num, 2);
}

size_t Uart::write(int num) {
	writeNum((float)num, 2);
}

size_t Uart::write(unsigned int num) {
	writeNum((float)num, 2);
}

size_t Uart::write(long num) {
	writeNum((float)num, 4);
}

size_t Uart::write(unsigned long num) {
	writeNum((float)num, 4);
}

size_t Uart::write(float num) {
	writeNum((float)num, 2);
}
