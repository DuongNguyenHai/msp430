...
public :
   ...
   // Print number
   size_t write(unsigned char num);
   size_t write(int num);
   size_t write(unsigned int num);
   size_t write(long num);
   size_t write(unsigned long num);
   size_t write(float num);
